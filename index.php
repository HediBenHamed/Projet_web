			  ...
			  <div class="navbar-header nav_2">
			   ...
			   <!-- Collect the nav links, forms, and other content for toggling -->
				<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
					...
					<!-------------------------------------->
					<div id="sidebar_title"><h2 align="center">Categories</h2></div>
					<!-------------------------------------->
					...
					<ul class="nav navbar-nav nav_1">
					 <!--*******Insertion de categories*******-->
      	    		  <?php  getCats(); ?>
      	    		  <a href="products.php"><h5 class="btn btn-outline-danger">Voir toutes les catégories</h5></a>
					 <!--*************************************-->
					</ul>
				 </div><!-- /.navbar-collapse -->
			</nav>
...
<!-- top-brands -->
	<div class="top-brands">
		<div class="container">
			<h1 align="center">Quelques Produits</h1>
